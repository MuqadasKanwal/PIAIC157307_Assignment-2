...
# 490, 525, 560, 595, 630, 665, 700, 735, 770, 805, 840, 875, 910,945, 980]""" 
...
z = np.zeros(shape=(4,5)) #wrtie your code here
z
#return z
#"""
#    Expected Output:
...
arr = np.zeros(10) #write your code here
arr
arr[5] = 10
arr[8] = 20
arr
...
np.set_printoptions(threshold=len(ans))
ans
#return ans
